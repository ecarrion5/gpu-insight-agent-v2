...
This is v2 of the earlier prototype. v1 proved "I can build an agent loop." v2 proves
"I can build a *production-shaped* agentic system."
...
| **Runtime constitution** | `constitution.md` | How the analysis agent *behaves*. (Two different constitutions — know the difference.) |
...
3. **Orchestrator** (`orchestrator.py`) — the state machine. Read this after 1–2; it's the spine.
...
# MCP handshake (in-memory, no subprocess) — quick check it's wired:
...
- **Eval graders are structural** (types/monotonicity). A fuller suite adds semantic
